...
class _Dropdown<T> extends StatelessWidget {
              ...
              children: [
                ...
                Flexible(
                  child: ListView.separated(
                    ...
                    itemBuilder: (_, int index) => _buildOption(
                      index,
                      theme,
  ...
  Widget _buildOption(int index, ThemeData theme, {bool isLast = false}) {
    ...
    return Ink(
      decoration: BoxDecoration(
        border: Border(
          bottom: BorderSide(
            color:
                isLast == true ? Colors.transparent : const Color(0xFF8A9FAB),
          ),
        ),
      ),
      child: ListTile(
